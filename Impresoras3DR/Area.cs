...
{
    public partial class Área : Form
    {
        public Área()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("area_insertar", con);
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.Add("@id_area", SqlDbType.VarChar).Value = txtidarea.Text;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No se elimino el dato" + ex.Message);
            }
