    ...
    public partial class Genero : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("genero_insertar", con);
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.Add("@id_genero", SqlDbType.VarChar).Value = txtid.Text;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("genero_actualizar", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                con.Close();
                MessageBox.Show("Dato actulizado con exito");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("genero_delete", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-SKCBF3Q ; Initial Catalog =Control_medicamentos; integrated Security = true");
            SqlCommand comando = new SqlCommand("SELECT * FROM genero", con);
            SqlDataAdapter adaptador = new SqlDataAdapter();
            adaptador.SelectCommand = comando;
            DataTable tabla = new DataTable();
            adaptador.Fill(tabla);
            datagenero.DataSource = tabla;
        }
    }
    }
